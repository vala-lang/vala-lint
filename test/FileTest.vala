...
class FileTest : GLib.Object {
    public static void check_file_for_mistake (File file, CheckTest.FileTestMistakeList mistake_list) {
    ...
    public static int main (string[] args) {
       ...
       check_file_for_mistake (CheckTest.get_test_file ("block-opening-brace-space-before-check.vala"),
       ...
       check_file_for_mistake (CheckTest.get_test_file ("double-spaces-check.vala"), double_spaces_warnings);
       ...
       check_file_for_mistake (CheckTest.get_test_file ("ellipsis-check.vala"), ellipsis_warnings);

        var empty_list = CheckTest.FileTestMistakeList ();
       check_file_for_mistake (CheckTest.get_test_file ("general-pass.vala"), empty_list);
       ...
       check_file_for_mistake (CheckTest.get_test_file ("general-warnings.vala"), general_warnings);

        var line_length_warnings = CheckTest.FileTestMistakeList ();
        line_length_warnings.add ("line-length", 8, 120, 141);
       check_file_for_mistake (CheckTest.get_test_file ("line-length-check.vala"), line_length_warnings);
        ...
        naming_convention_warnings.add ("naming-convention", 1);
        naming_convention_warnings.add ("naming-convention", 1);
       check_file_for_mistake (CheckTest.get_test_file ("naming-convention-check.vala"),
       ...
       check_file_for_mistake (CheckTest.get_test_file ("note-check.vala"), note_warnings);
       ...
       check_file_for_mistake (CheckTest.get_test_file ("space-before-paren-check.vala"),
                                        space_before_paren_warnings);

        var tab_warnings = CheckTest.FileTestMistakeList ();
        tab_warnings.add ("use-of-tabs", 5, 20, 21);
       check_file_for_mistake (CheckTest.get_test_file ("tab-check.vala"), tab_warnings);

       check_file_for_mistake (CheckTest.get_test_file ("trailing-newlines-check-1.vala"), empty_list);

        var trailing_newlines_2_warnings = CheckTest.FileTestMistakeList ();
        trailing_newlines_2_warnings.add ("trailing-newlines", 5, 0, 1);
       check_file_for_mistake (CheckTest.get_test_file ("trailing-newlines-check-2.vala"),
       ...
       check_file_for_mistake (CheckTest.get_test_file ("trailing-newlines-check-3.vala"),
       ...
       check_file_for_mistake (CheckTest.get_test_file ("trailing-newlines-check-4.vala"),
       ...
       check_file_for_mistake (CheckTest.get_test_file ("trailing-whitespace-check.vala"),
                                        trailing_whitespace_warnings);

       check_file_for_mistake (CheckTest.get_test_file ("empty-file.vala"), empty_list);
